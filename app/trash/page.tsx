          ...
          <div className="flex-1 p-4 pt-12 md:pt-4">
            ...
            <Card className="shadow-md">
              <CardHeader className="bg-slate-50 dark:bg-gray-800">
                <CardTitle className="text-xl text-gray-900 dark:text-white">Deleted Recipes</CardTitle>
              </CardHeader>
              <CardContent className="pt-6 bg-white dark:bg-gray-800">
                <p className="text-base text-gray-800 dark:text-gray-200 font-medium">This is where you'll see your deleted recipes.</p>
                {/* If no deleted recipes */}
                <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800">
                  <p className="text-amber-800 dark:text-amber-300 font-medium">No deleted recipes yet. Items you delete will remain here for 30 days before being permanently removed.</p>
                </div>
              </CardContent>
            </Card>
          </div>
