      ...
      <div className="flex-1 md:ml-64 min-h-screen">
        <div className="flex h-full flex-col">
          ...
          <div className="flex-1 p-4 pt-12 md:pt-4">
            <h1 className="text-3xl font-bold mb-4 text-gray-800 dark:text-white">Archive</h1>
            <Card className="shadow-md">
              <CardHeader className="bg-slate-50 dark:bg-gray-800">
                <CardTitle className="text-xl text-gray-900 dark:text-white">Archived Recipes</CardTitle>
              </CardHeader>
              <CardContent className="pt-6 bg-white dark:bg-gray-800">
                <p className="text-base text-gray-800 dark:text-gray-200 font-medium">This is where you'll see your archived recipes.</p>
                {/* If no archived recipes */}
                <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 rounded-md border border-amber-200 dark:border-amber-800">
                  <p className="text-amber-800 dark:text-amber-300 font-medium">No archived recipes yet. When you archive recipes, they will appear here.</p>
                </div>
              </CardContent>
            </Card>
          </div>
